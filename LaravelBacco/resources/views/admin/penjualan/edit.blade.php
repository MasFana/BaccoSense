...
@section('title', 'Edit Penjualan Produk')
    ...
    <main class="container mx-auto min-h-screen p-4 md:p-6">
        <div class="overflow-hidden rounded-lg bg-white shadow-md">
            ...
            <div class="flex flex-col items-start justify-between border-b border-gray-200 p-4 md:flex-row md:items-center">
                <h1 class="mb-2 text-xl font-semibold text-gray-800 md:mb-0">Edit Penjualan</h1>
                    ...
                    <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                        ...
                        <div class="col-span-2">
                            ...
                            <input
                                ...
                                value="{{ $penjualan->produk->nama_produk }}" placeholder="Masukkan nama produk" disabled>
                        </div>
                        <input name="produk_id" type="hidden" value="{{ $penjualan->produk_id }}">
                        <!-- Price -->
                        <div class="col-span-2 md:col-span-1">
                            <label class="mb-1 block text-sm font-medium text-gray-700" for="harga">Harga (Rp)</label>
                            <input
                                class="w-full rounded-md border border-gray-300 px-4 py-2 focus:border-blue-500 focus:ring-blue-500"
                                id="harga" name="harga" type="number" value="{{ $penjualan->harga }}"
                        ...
                        <div class="col-span-2 md:col-span-1">
                            ...
                            <input
                                class="w-full rounded-md border border-gray-300 px-4 py-2 focus:border-blue-500 focus:ring-blue-500"
                                id="jumlah" name="jumlah" type="number" value="{{ $penjualan->jumlah }}"
                                placeholder="Masukkan jumlah penjualan" min="0" required>
                        </div>
